...
const Page = withViews(({ tweets, views }) => (
  <Post tweets={tweets}>
    <Header title="Uses This" date="Sep 1, 2020" views={views} />
    <Head>
      <meta property="og:title" content="Uses This" />
      <meta property="og:site_name" content="Utkarsh Gupta's Blog" />
      <meta
        property="og:description"
        content="I dive into my day to day tools to understand my environment."
      />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:site" content="@wizugupta" />
      <meta
        property="og:image"
        content="https://res.cloudinary.com/utkarshshh/image/upload/v1602871044/Blog/audric-wonkam-V5FcjzMBSkU-unsplash_iy0wfe.jpg"
      />
    </Head>
    <P>
      Inspired by {" "}
